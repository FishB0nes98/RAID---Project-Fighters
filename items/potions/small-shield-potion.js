/**
 * Small Shield Potion
 * Restores 25 shield points after a 2-second charge time
 * Charge is canceled if player walks
 */

import { BaseItem } from '../base-item.js';

class SmallShieldPotion extends BaseItem {
    constructor() {
        // Create the potion image
        const image = BaseItem.createImage(32, 32, (ctx, width, height) => {
            // Draw potion bottle
            ctx.fillStyle = '#64B5F6'; // Lighter blue for small shield
            ctx.beginPath();
        ...
        super(
            'small-shield-potion',
            'Small Shield Potion',
            'Restores 25 shield points after a 2-second charge time. Charge is canceled if you move.',
            image
        );
